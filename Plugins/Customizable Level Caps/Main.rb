...
LEVEL_CAP = [15,27,38,50,62,75,82,89,91,93,95,97,100]
...
class Battle
  def pbGainExpOne(idxParty, defeatedBattler, numPartic, expShare, expAll, showMessages = true)
    ...
    wild_level_gap = (pkmn.level + 3 <= level_cap) ? growth_rate.exp_values[pkmn.level + 3] - pkmn.exp : level_cap_gap
    ...
    exp = wildBattle? ? wild_level_gap : level_cap_gap
